...
cv2.createTrackbar('hueUpper', 'Trackbars',128,179,nothing)

cv2.createTrackbar('hue2Lower', 'Trackbars',85,179,nothing)
...
cv2.createTrackbar('valHigh','Trackbars',120,255,nothing)
